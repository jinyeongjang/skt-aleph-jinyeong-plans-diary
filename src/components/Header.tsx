...
export const Header: React.FC<HeaderProps> = ({ onOpenGuide, onOpenExport, isDark, onToggleTheme }) => {
  return (
    <header className="fixed inset-x-0 top-0 z-50 h-16 border-b border-white/80 bg-white/75 shadow-[0_4px_24px_rgba(0,0,0,0.04)] backdrop-blur-2xl transition-all dark:border-white/[0.08] dark:bg-neutral-950/75 dark:shadow-[0_4px_24px_rgba(0,0,0,0.4)]">
      {/* Top Rim Light */}
      <div
      ...
      <div className="mx-auto flex h-full max-w-7xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-indigo-500/20 bg-gradient-to-br from-indigo-500 to-violet-600 text-white shadow-md shadow-indigo-500/20">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="hover-lift active-press flex h-8.5 w-8.5 cursor-pointer items-center justify-center rounded-xl border border-neutral-200/80 bg-white/70 text-neutral-700 shadow-2xs backdrop-blur-md transition-all hover:bg-white dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-neutral-200 dark:hover:bg-white/[0.08]"
            aria-label="테마 전환"
          >
