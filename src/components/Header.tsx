      ...
      <div className="mx-auto flex h-full max-w-7xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            onClick={onOpenGuide}
            className="glass-pill hover-lift active-press flex cursor-pointer items-center gap-1.5 rounded-xl px-2.5 py-1.5 text-xs font-semibold text-neutral-700 shadow-2xs transition-all hover:bg-neutral-100 dark:text-neutral-200 dark:hover:bg-neutral-800"
          ...
          <a
            href="#fixed-tests"
            className="glass-pill hover-lift active-press hidden items-center gap-1.5 rounded-xl border-emerald-500/30 bg-emerald-50/50 px-2.5 py-1.5 text-xs font-bold text-emerald-700 shadow-2xs transition-all hover:bg-emerald-100/60 sm:flex dark:border-emerald-500/30 dark:bg-emerald-950/30 dark:text-emerald-300"
          >
          ...
          <button
            ...
            className="glass-pill hover-lift active-press flex h-8 w-8 cursor-pointer items-center justify-center rounded-xl text-neutral-700 shadow-2xs transition-all hover:bg-neutral-100 dark:text-neutral-200 dark:hover:bg-neutral-800"
            aria-label="테마 전환"
          >
