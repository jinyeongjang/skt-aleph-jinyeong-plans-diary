    ...
    >
      <div className="relative flex max-h-[90vh] w-full max-w-xl flex-col overflow-hidden rounded-3xl border border-neutral-200/90 bg-white shadow-[0_25px_60px_-15px_rgba(0,0,0,0.3)] dark:border-neutral-800/90 dark:bg-neutral-900 dark:shadow-[0_25px_60px_-15px_rgba(0,0,0,0.7)]">
        ...
        <div className="custom-scrollbar space-y-5 overflow-y-auto p-6">
          ...
          <div className="rounded-2xl border border-neutral-200/80 bg-neutral-50/80 p-4 shadow-xs dark:border-neutral-800/80 dark:bg-neutral-950/50">
            <div className="mb-1.5 flex items-center justify-between text-xs text-neutral-500 dark:text-neutral-400">
              <span className="font-semibold text-neutral-600 dark:text-neutral-300">대상 할 일</span>
              <span className="inline-flex items-center gap-1 rounded-full border border-emerald-500/20 bg-emerald-500/10 px-2.5 py-0.5 font-mono text-[11px] font-semibold text-emerald-600 dark:border-emerald-500/30 dark:bg-emerald-500/15 dark:text-emerald-400">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-neutral-200/80 bg-neutral-50/80 px-3.5 py-2.5 text-xs text-neutral-900 shadow-2xs transition-all focus:border-emerald-500 focus:bg-white focus:ring-2 focus:ring-emerald-500/20 focus:outline-none dark:border-neutral-800 dark:bg-neutral-800/50 dark:text-neutral-100 dark:focus:bg-neutral-900"
                  required
                />
              </div>
              <div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-2xl border border-neutral-200/80 bg-neutral-50/80 px-3.5 py-2.5 text-xs font-bold text-neutral-900 shadow-2xs transition-all focus:border-emerald-500 focus:bg-white focus:ring-2 focus:ring-emerald-500/20 focus:outline-none dark:border-neutral-800 dark:bg-neutral-800/50 dark:text-neutral-100 dark:focus:bg-neutral-900"
                required
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full rounded-2xl border border-neutral-200/80 bg-neutral-50/80 px-3.5 py-2.5 text-xs text-neutral-900 shadow-2xs transition-all placeholder:text-neutral-400 focus:border-emerald-500 focus:bg-white focus:ring-2 focus:ring-emerald-500/20 focus:outline-none dark:border-neutral-800 dark:bg-neutral-800/50 dark:text-neutral-100 dark:focus:bg-neutral-900"
              />
            </div>

            {/* 연타 멱등성 검증 결과 안내 */}
            {doubleClickStatus && (
              <div className="flex items-center gap-2 rounded-2xl border border-emerald-500/30 bg-emerald-500/15 p-3.5 text-xs font-semibold text-emerald-800 shadow-xs dark:border-emerald-500/30 dark:bg-emerald-500/20 dark:text-emerald-300">
              ...
              <div className="border-t border-neutral-100 pt-3 dark:border-neutral-800/80">
                ...
                <div className="max-h-32 space-y-2 overflow-y-auto">
                  {existingLogs.map((log) => (
                    <div
                      key={log.id}
                      className="flex items-center justify-between rounded-xl border border-neutral-200/60 bg-neutral-50/80 p-2.5 text-xs dark:border-neutral-800/60 dark:bg-neutral-800/60"
                    >
                      <div>
            ...
            {/* Action Buttons */}
            <div className="flex flex-col items-center justify-between gap-2.5 border-t border-neutral-100/80 pt-4 sm:flex-row dark:border-neutral-800/80">
              {/* T06-C21 연타 멱등성 테스트 버튼 */}
              <button
                type="button"
                onClick={handleDoubleFireTest}
                className="hover-lift active-press inline-flex w-full cursor-pointer items-center justify-center gap-1.5 rounded-2xl border border-amber-500/30 bg-amber-500/10 px-3.5 py-2.5 text-xs font-bold text-amber-700 shadow-2xs transition-all hover:bg-amber-500/20 sm:w-auto dark:border-amber-400/30 dark:bg-amber-500/15 dark:text-amber-300"
