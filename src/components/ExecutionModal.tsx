...
export const ExecutionModal: React.FC<ExecutionModalProps> = ({
  ...
  return createPortal(
    ...
    >
      <div className="relative flex max-h-[90vh] w-full max-w-xl flex-col overflow-hidden rounded-3xl border border-white/60 bg-white/90 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.15)] backdrop-blur-2xl dark:border-white/10 dark:bg-neutral-900/90 dark:shadow-[0_25px_60px_-15px_rgba(0,0,0,0.7)]">
        {/* Header */}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-neutral-200/80 bg-neutral-50/70 px-3.5 py-2.5 text-xs font-bold text-neutral-900 shadow-2xs transition-all focus:border-emerald-500 focus:bg-white focus:ring-2 focus:ring-emerald-500/20 focus:outline-none dark:border-neutral-800 dark:bg-neutral-800/50 dark:text-neutral-100 dark:focus:bg-neutral-900"
                required
              />
            </div>
            ...
            {/* Action Buttons */}
            <div className="flex flex-col items-center justify-between gap-2.5 border-t border-neutral-100 pt-4 sm:flex-row dark:border-neutral-800/80">
