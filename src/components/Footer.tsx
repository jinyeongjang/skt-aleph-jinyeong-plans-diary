...
export const Footer: React.FC = () => {
  return (
    <footer className="relative mt-20 border-t border-neutral-200/70 bg-white/70 py-10 backdrop-blur-2xl dark:border-white/8 dark:bg-neutral-950/70">
      {/* 상단 은은한 림라이트 */}
      <div
      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-4 text-xs text-neutral-500 sm:flex-row sm:px-6 dark:text-neutral-400">
        <div>
          <p className="font-bold text-neutral-900 dark:text-neutral-100">
            SKT ALEPH - 플랜두씨 다이어리 1 — 내 계획과 실제를 담는 앱
          </p>
        </div>
      </div>
    </footer>
