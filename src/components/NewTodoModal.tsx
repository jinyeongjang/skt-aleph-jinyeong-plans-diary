      ...
      <div className="relative flex max-h-[90vh] w-full max-w-lg flex-col overflow-hidden rounded-3xl border border-white/80 bg-white/85 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.2)] backdrop-blur-2xl dark:border-white/10 dark:bg-neutral-900/85 dark:shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8)]">
        ...
        <div className="flex items-center justify-between border-b border-neutral-200/70 px-6 py-5 dark:border-white/[0.08]">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-2xl border border-emerald-500/20 bg-gradient-to-br from-emerald-500/20 to-teal-500/20 text-emerald-600 shadow-inner backdrop-blur-md dark:border-emerald-400/30 dark:text-emerald-400">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="glass-pill rounded-full border-emerald-500/30 bg-emerald-500/10 px-2 py-0.5 text-[11px] font-bold text-emerald-700 dark:text-emerald-300">
                  T06-C09
                </span>
              </div>
        ...
        <form onSubmit={handleSubmit} className="custom-scrollbar flex flex-col overflow-y-auto">
          <div className="space-y-4 p-6">
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-neutral-200/80 bg-neutral-50/70 px-3.5 py-2.5 text-xs text-neutral-900 shadow-2xs backdrop-blur-xs transition-all focus:border-emerald-500 focus:bg-white focus:ring-2 focus:ring-emerald-500/20 focus:outline-none dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-neutral-100 dark:focus:bg-neutral-900"
                required
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-neutral-200/80 bg-neutral-50/70 px-3 py-2.5 text-xs text-neutral-900 shadow-2xs backdrop-blur-xs transition-all focus:border-emerald-500 focus:bg-white focus:ring-2 focus:ring-emerald-500/20 focus:outline-none dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-neutral-100 dark:focus:bg-neutral-900"
                  required
                />
              </div>
              <div>
          ...
          <div className="flex items-center justify-end gap-2.5 border-t border-neutral-200/70 px-6 py-4 dark:border-white/[0.08]">
            ...
            <button
              type="submit"
              className="hover-lift active-press cursor-pointer rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 px-5 py-2.5 text-xs font-bold text-white shadow-md shadow-emerald-600/20 transition-all hover:from-emerald-500 hover:to-teal-500"
            >
              할 일 등록
            </button>
          </div>
