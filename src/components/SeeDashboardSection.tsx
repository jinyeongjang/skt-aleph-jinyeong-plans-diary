    ...
    <section id="see-section" className="glass-card rounded-3xl p-6 sm:p-7">
      ...
      <div className="flex flex-col justify-between gap-4 border-b border-neutral-200/80 pb-5 sm:flex-row sm:items-center dark:border-neutral-800/80">
        <div className="flex items-center gap-3.5">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-purple-500/20 bg-purple-500/10 text-purple-600 shadow-inner dark:border-purple-500/30 dark:bg-purple-500/15 dark:text-purple-400">
          ...
          <div>
            ...
            <h2 className="mt-0.5 flex flex-wrap items-center gap-2 text-xl font-bold tracking-tight text-neutral-900 sm:text-2xl dark:text-neutral-100">
              돌아보기 대시보드
      ...
      <div className="mt-5 grid grid-cols-2 gap-3.5 lg:grid-cols-4">
        ...
        >
          <div className="mb-2 flex items-center justify-between text-xs font-medium text-neutral-500 dark:text-neutral-400">
            ...
            <PieChart className="h-4 w-4 text-neutral-400 transition-colors group-hover:text-indigo-500" />
          </div>
      ...
      <div className="glass-panel mt-5 rounded-2xl p-5">
        <div className="mb-3.5 flex items-center justify-between">
          ...
          <span className="font-mono text-xs font-medium text-neutral-500">공식: 실제 시간 - 예상 시간</span>
        </div>
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-neutral-200/80 bg-white p-3.5 shadow-2xs dark:border-neutral-800 dark:bg-neutral-900">
            <span className="mb-1 block text-xs font-medium text-neutral-500">총 실제 시간 (실행)</span>
      ...
      <div className="mt-5 rounded-2xl border border-purple-500/25 bg-purple-500/8 p-5 shadow-2xs dark:border-purple-400/25 dark:bg-purple-500/10">
        ...
        <form onSubmit={handleTransferToNextPlan} className="space-y-3.5">
          <div>
            <textarea
              ...
              className="w-full rounded-xl border border-neutral-300/80 bg-white px-3.5 py-2.5 text-xs text-neutral-900 shadow-2xs focus:border-purple-500 focus:ring-2 focus:ring-purple-500/30 sm:text-sm dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-100"
              required
            />
          </div>
          ...
          <div className="flex flex-col items-center justify-between gap-3 sm:flex-row">
            ...
            <button
              type="submit"
              disabled={isSaving}
              className="hover-lift active-press inline-flex w-full cursor-pointer items-center justify-center gap-1.5 rounded-xl bg-purple-600 px-4 py-2.5 text-xs font-bold text-white shadow-xs transition-colors hover:bg-purple-700 disabled:opacity-50 sm:w-auto"
            >
