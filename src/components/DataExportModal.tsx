        ...
        <div className="flex flex-col items-center justify-between gap-3 border-t border-neutral-100/80 px-6 py-4 sm:flex-row dark:border-neutral-800/80">
          ...
          <div className="flex w-full items-center justify-end gap-2.5 sm:w-auto">
            ...
            <button
              ...
              className="hover-lift active-press inline-flex cursor-pointer items-center gap-1.5 rounded-2xl bg-linear-to-r from-blue-600 to-indigo-600 px-5 py-2.5 text-xs font-bold text-white shadow-md shadow-blue-600/25 transition-all hover:from-blue-500 hover:to-indigo-500"
            >
