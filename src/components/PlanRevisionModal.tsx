          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="rounded-full border border-indigo-500/30 bg-indigo-50 px-2.5 py-0.5 text-[10px] font-bold text-indigo-700 dark:bg-indigo-950/50 dark:text-indigo-300">
                  T06-C08 원본 보존
                </span>
              </div>
              ...
              <div className="space-y-3">
                {revisions.map((rev) => (
                  ...
                  >
                    ...
                    <div className="mt-2.5 rounded-xl border border-neutral-200 bg-neutral-100/80 p-3 text-xs text-neutral-600 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-400">
