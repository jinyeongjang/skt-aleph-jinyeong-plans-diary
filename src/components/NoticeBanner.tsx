    ...
    <div className="relative overflow-hidden rounded-2xl border border-amber-500/30 bg-amber-500/10 p-3.5 shadow-xs backdrop-blur-xl dark:border-amber-400/25 dark:bg-amber-500/10">
      ...
      <div className="relative z-10 flex flex-col items-center justify-between gap-3 text-xs sm:flex-row sm:text-sm">
        ...
        <div className="flex items-center gap-2.5 font-medium text-amber-950 dark:text-amber-100">
          <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border border-amber-500/30 bg-amber-500/20 text-amber-600 shadow-inner dark:border-amber-400/30 dark:bg-amber-400/20 dark:text-amber-300">
